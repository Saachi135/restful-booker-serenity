...
import com.restful.booker.serenity.model.UpdateBookingPojo;
...
public class UpdateSteps {
    ...
    @Step("Update Booking using token {0}, bookingid {1}, firstname {2}, lastname {3}, totalprice {4}, depositpaid {5}, checkin date {6}, checkout {7}, checkout {8}, additionalneeds {9}")
